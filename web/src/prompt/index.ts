...
const ChatGPTTerminalMessage: ChatMessage[] = [
  ...
  },
  {
    role: "assistant",
    content:
      "Yes, I will do it for you. Please type the command and I will reply with the terminal output.",
    type: "text",
    first: true,
  },
];
...
const ChatGPTPolishMessage: ChatMessage[] = [
  ...
  },
  {
    role: "user",
    content:
      "You are a well-trained AI writing assistant with expertise in writing academic papers for computer conferences. By giving you a draft paragraph, I hope you can help me polish my writing with your knowledge. The language should be concise and consistent with the style of an academic paper.",
    type: "text",
    first: true,
  },
  {
...
const defaultHuggingGPTMessage: ChatMessage[] = [
  {
    role: "assistant",
    content:
      "Hi there, I am HuggingGPT empowered by Huggingface family! Yes, I can provide thousands of models for dozens of tasks. For more fun and creativity, I have invited Diffusers family to join our team. Feel free to experience it!",
    type: "text",
    first: true,
  },
];
