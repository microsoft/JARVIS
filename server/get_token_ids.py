...
def count_tokens(model_name, text):
    return len(encodings[MOCK_OPENAI_LLM or model_name].encode(text))

def get_max_context_length(model_name):
    return max_length[MOCK_OPENAI_LLM or model_name]
...
def get_token_ids_for_task_parsing(model_name):
    ...
    res = encodings[MOCK_OPENAI_LLM or model_name].encode(text)
    res = list(set(res))
    return res
